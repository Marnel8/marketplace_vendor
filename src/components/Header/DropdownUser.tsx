...
import { useFetchCurrentUser, useLogout } from "@/hooks/useAuth";
import toast from "react-hot-toast";
import { useRouter } from "next/navigation";

const DropdownUser = () => {
  const [dropdownOpen, setDropdownOpen] = useState(false);
  const { data: user, isLoading, refetch } = useFetchCurrentUser();
            ...
            >
              ...
              <span className="h-12 w-12 rounded-full">
                {user.user?.avatar ? (
                  ...
                  <div className="flex h-full items-center justify-center rounded-full bg-blue-100 dark:bg-meta-4">
                    <p>
